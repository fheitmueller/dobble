...
#' @param shape defines the shape of the cards: can be "circle"  (default), "blank" or "rectangle"
#' @return a set of dobble cards saved in the outfolder
#' @import magick
#' @export


folder_to_cards <- function(infolder, outfolder, output="SINGLE", shape="circle"){
...
all_cards <- generate_all_cards(image_list, shape=shape)
...
if(output=="DINA4"){
sheet_list <- cards_to_A4(all_cards)
